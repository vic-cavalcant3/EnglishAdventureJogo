...
$nome_atividade = 'jogo3_fase1'; // Identificador único
...
// ============================================
// ============================================
// LÓGICA DA QUESTÃO - VERSÃO CORRIGIDA
// ============================================
options.forEach(btn => {
    btn.addEventListener("click", () => {
        ...
        // ⭐ CORREÇÃO: Remover as linhas com chosenSpan ou defini-la
        if (isCorrect) {
            // chosenSpan.style.color = "#388e3c"; // REMOVER ESTA LINHA
            feedback.textContent = "✔ Resposta correta!";
            feedback.style.color = "#388e3c";
            btn.classList.add("selected-correct");
            giveXP(true);
        } else {
            // chosenSpan.style.color = "#b71c1c"; // REMOVER ESTA LINHA
