...
$numero_fase = 6; // Fase 6 do Jogo 3
$jogo_numero = 3; // Jogo 3 (Floresta Escura)
...
$nome_atividade = 'jogo3_fase6'; // Identificador único

// ✅ BUSCAR XP ATUAL DESTA FASE DO JOGO 3
$xp_atual_fase = obterXPFase2($pdo, $usuario_id, $numero_fase);
$xp_total_jogo3 = obterXPTotal2($pdo, $usuario_id);
...
<body>
    ...
    <div class="main-content">
        <div class="question-container">
            <p class="instruction">Identifique a frase negativa</p>
            <p class="question-phrase" id="questionPhrase">What isn't the wolf?</p>
            ...
            <div class="options">
                <button class="option-btn" data-is-correct="true">A) It isn't dangerous.</button>
                <button class="option-btn" data-is-correct="false">B) It isn't pretty.</button>
            </div>
    ...
    <script>
// ============================================
// CONFIGURAÇÕES - JOGO 3 (Floresta Escura)
// ============================================
...
// ============================================
const audio = new Audio("sound/thewolfisnotdangeours.mpeg");
