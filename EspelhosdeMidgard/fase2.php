...
// ⭐ DEFINIR: Esta é a FASE 2 do Jogo 4 (Espelhos de Midgard)
$numero_fase = 2;
$jogo_numero = 4;

// ⭐ DEFINIR TIPO DA QUESTÃO
$tipo_gramatica = 'interrogativa';
$tipo_habilidade = 'reading';
$nome_atividade = 'jogo4_fase2';
...
<body>
    ...
    <div class="main-content">
        <div class="question-container">
            <p class="instruction">Responda</p>
            <p class="question-phrase" id="questionPhrase">Are you my best friend?</p>

            <div class="options">
                <button class="option-btn" data-is-correct="true">A) Yes, I am?</button>
                <button class="option-btn" data-is-correct="false">B) Yes, I are?</button>
                <button class="option-btn" data-is-correct="false">C) Yes, I is?</button>
            </div>
