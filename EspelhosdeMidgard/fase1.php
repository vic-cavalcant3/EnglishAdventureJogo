...
// ⭐ DEFINIR: Esta é a FASE 6 do Jogo 3 (Floresta Escura)
$numero_fase = 1; // Fase 6 do Jogo 3
$jogo_numero = 4; // Jogo 3 (Floresta Escura)
    ...
    <div class="main-content">
        <div class="question-container">
            ...
            <div class="audio-control-container">
                <p class="audio-prompt" id="audioPrompt">Listening the audio </p>
                <button class="speed-btn active" data-speed="1.0">1.0x</button>
                <button class="speed-btn" data-speed="0.5">0.5x</button>
            </div>

            <div class="options">
                <button class="option-btn" data-is-correct="false">A) Is he your friend?</button>
                <button class="option-btn" data-is-correct="true">B) Am I your friend?</button>
                <button class="option-btn" data-is-correct="false">C) Are I your friend?</button>
...
let questaoJaFoiPontuada = false; // ✅ NOVA VARIÁVEL

updateXPBar();

console.log('🎮 Jogo 3 - Fase iniciada:', {
    jogo: JOGO_NUMERO,
    fase: NUMERO_FASE,
...
// ============================================
const audio = new Audio("sound/amIyourfriend.mp3");
...
audioPrompt.addEventListener("click", playAudio);
...
// ✅ CORREÇÃO: Removi a barra extra e garanti que salva sempre
options.forEach(btn => {
    btn.addEventListener("click", () => {
        // ✅ DUPLA VERIFICAÇÃO: Não pode responder se já respondeu E não pode pontuar novamente
        ...
        jaRespondeu = true;
        questaoJaFoiPontuada = true; // ✅ MARCA QUE JÁ GANHOU XP
        ...
        // ✅ SALVAR NO BANCO (só executa uma vez)
...
// ✅ IMPEDIR CLIQUE DUPLO RÁPIDO
function disableOptions() {
    options.forEach(btn => {
        btn.disabled = true;
        btn.style.pointerEvents = 'none';
        btn.style.opacity = '0.7'; // Visualmente desabilitado
    });
}
...
document.querySelector(".vocabulario-btn").addEventListener("click", () => {
    alert("Dicionário em desenvolvimento!");
});
