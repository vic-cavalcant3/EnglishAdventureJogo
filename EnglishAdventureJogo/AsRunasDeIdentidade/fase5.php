...
$numero_fase = 5; // MUDE PARA O NÚMERO DA FASE ATUAL
...
$nome_atividade = 'jogo2_fase5'; // Identificador único
   ...
   <img src="imgs/sair.png" alt="Sair"/>
    ...
    <div class="main-content">
        <div class="question-container">
            ...
            <div class="options">
                <button class="option-btn">A) He is strong.</button>
                <button class="option-btn">B) You is strong.</button>
                <button class="option-btn correct">C) You are strong.</button>
            </div>
...
<iframe id="sairModal2" src=""></iframe>
    ...
    <script>
        ...
        audio.src = "sound/youarestrong.mpeg";
