...
$nome_atividade = 'jogo2_fase10'; // Identificador único
...
<head>
 ...
 /* XP BAR */
        ...
        .dragon.gaining-xp {
            animation: pulseDragon 0.2s ease;
        }
    ...
    <div class="main-content">
        ...
        <div class="question-container" id="questionContainer">
            ...
            <div class="pronunciation-phrase-box">
                <span class="pronunciation-phrase" id="pronunciationText">I am a hero!</span>
            </div>
...
function salvarXPNoBanco() {
    ...
    formData.append('fase', NUMERO_FASE);
    formData.append('xp', xpFaseAtual);

    console.log('📤 Salvando XP:', {
        aluno: NOME_ALUNO,
        fase: NUMERO_FASE,
        xp_final_fase: xpFaseAtual
    });
