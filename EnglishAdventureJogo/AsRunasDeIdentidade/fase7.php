...
$nome_atividade = 'jogo2_fase7'; // Identificador único
   ...
   <img src="imgs/sair.png" alt="Sair"/>
    ...
    <div class="main-content">
        <div class="question-container">
            ...
            <p class="question-phrase" id="questionPhrase">She powerful</p>
...
options.forEach(btn => {
    btn.addEventListener("click", () => {
        ...
        questionPhrase.innerHTML = `She <span id="chosenWord">${chosenWord}</span> powerful`;
