...
$numero_fase = 3; // FASE 2 - Espelhos de Midgard

$tipo_gramatica = 'afirmativa'; // 'afirmativa', 'interrogativa' ou 'negativa'
$tipo_habilidade = 'speaking'; // 'speaking', 'reading', 'listening' ou 'writing'
$nome_atividade = 'jogo2_fase3'; // Identificador único
  ...
  <title>English Adventure</title>
    ...
    <style>
        * {
        ...
        /* BOTÕES DE VELOCIDADE INICIA INVISÍVEIS */
        .speed-btn {
    ...
    <div class="main-content">
        ...
        <div class="question-container" id="questionContainer">
            ...
            <div class="pronunciation-phrase-box">
                <span class="pronunciation-phrase" id="pronunciationText">They are happy.</span>
            </div>
        ...
        <button id="next-phase-btn-outside">Avançar</button>
    </div>
...
<iframe id="pocaoModal" src="../atributos/poção/is.html"></iframe>
...
// ============================================
// SALVAR XP NO BANCO - VERSÃO CORRIGIDA
// ============================================
...
// ============================================
let audio = new Audio();
audio.src = "sound/theyarehappy.mpeg";
...
if (recognition) {
    recognition.addEventListener("result", event => {
        ...
        if (correct) {
            ...
            salvarProgressoDetalhado(true);  // ✅ ADICIONAR
            salvarXPNoBanco();
            ...
            // ⭐ SALVAR PROGRESSO MESMO QUANDO ERRAR
            salvarProgressoDetalhado(false);  // ✅ ADICIONAR
            salvarXPNoBanco();
