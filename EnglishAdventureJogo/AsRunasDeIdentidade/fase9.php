...
$nome_atividade = 'jogo2_fase9'; // Identificador único
   ...
   <img src="imgs/sair.png" alt="Sair"/>
    ...
    <div class="main-content">
        <div class="question-container">
            ...
            <p class="question-phrase" id="questionPhrase">He is my friend</p>

            <div class="options">
                <button class="option-btn ">A) Yes, He am</button>
                <button class="option-btn ">B) Yes, He are</button>
                <button class="option-btn correct ">C) Yes, He is</button>
            </div>
...
options.forEach(btn => {
    btn.addEventListener("click", () => {
        ...
        questionPhrase.innerHTML = `He is my friend. <span id="chosenWord">${chosenWord}</span>`;
