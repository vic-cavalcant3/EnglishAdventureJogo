...
$pode_jogar = verificarPermissaoFase($pdo, 2, 1); // Jogo 2, Fase 1
...
<head>
    ...
    <title>English Adventure - Fase 1</title>
...
<?php 
  ...
  if (!$pode_jogar) {
      echo gerarOverlayBloqueio(2, 1); // Jogo 1, Fase 3
  }
  ?>
   ...
   <img src="imgs/sair.png" alt="Sair"/>
    ...
    <div class="main-content">
        <div class="question-container">
            ...
            <p class="question-phrase" id="questionPhrase">I  a viking</p>

            <div class="options">
                <button class="option-btn">A) Are</button>
                <button class="option-btn correct">B) Am</button>
                <button class="option-btn">C) Is</button>
            </div>
...
options.forEach(btn => {
    btn.addEventListener("click", () => {
        ...
        questionPhrase.innerHTML = `I <span id="chosenWord">${chosenWord}</span> a viking`;
