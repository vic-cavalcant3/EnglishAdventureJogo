...
$nome_atividade = 'jogo2_fase8'; // Identificador único
   ...
   <img src="imgs/sair.png" alt="Sair"/>
    ...
    <div class="main-content">
        <div class="question-container">
            ...
            <p class="question-phrase" id="questionPhrase">You are a viking</p>

            <div class="options">
                <button class="option-btn correct">A) Yes, I am</button>
                <button class="option-btn ">B)  Yes, I are</button>
                <button class="option-btn">C) Yes, I is</button>
            </div>
...
// VARIÁVEIS DE XP
// ============================================
let xpFaseAtual = XP_ATUAL_FASE; // XP só desta fase (para cálculo)
let xpTotalAcumulado = XP_TOTAL_ACUMULADO; // XP total (para exibição na barra)
...
function giveXP(isCorrect) {
    ...
    // Atualizar XP da fase atual (para cálculo de estrelas)
    xpFaseAtual += xpChange;
    if (xpFaseAtual < 0) xpFaseAtual = 0;
    if (xpFaseAtual > 10) xpFaseAtual = 10;
    
    // Atualizar XP total (para exibir na barra)
...
function calcularEstrelas() {
    ...
    // ⭐ ESTRELAS baseadas no XP DA FASE ATUAL (não no total)
    if (xpFaseAtual >= 8) {
        estrelas = 3;
...
options.forEach(btn => {
    btn.addEventListener("click", () => {
        ...
        questionPhrase.innerHTML = `You are <span id="chosenWord"></span> a viking`;
