...
// ⭐ DEFINIR: Esta é a FASE 4 do Jogo 2 (Floresta Escura)
$numero_fase = 4; // Fase 4 do Jogo 2
...
$nome_atividade = 'jogo3_fase4'; // Identificador único
...
<head>
    ...
    <title>Fase 4 - Espelhos de Midgard</title>
   ...
   <img src="imgs/sair.png" alt="Sair"/>
    ...
    <div class="main-content">
        <div class="question-container">
            <p class="instruction">Reescreva na negativa</p>
            <p class="question-phrase" id="questionPhrase">The warriors are confident.</p>
...
function processAnswer() {
    ...
    const acceptedAnswers = [
        "the warriors aren't confident.",
        "the warriors aren't confident",
        "the warriors are not confident.",
        "the warriors are not confident"
    ...
    if (isCorrect) {
        ...
        const correctAnswer = "The warriors are not confident.";
