...
// ⭐ DEFINIR: Esta é a FASE 3 do Jogo 3 (Floresta Escura)
$numero_fase = 3; // Fase 3 do Jogo 3
...
$nome_atividade = 'jogo3_fase3'; // Identificador único
...
error_log("🎮 Jogo 3 - Fase $numero_fase | XP Fase: $xp_atual_fase | XP Total: $xp_total_jogo2");
   ...
   <img src="imgs/sair.png" alt="Sair"/>
    ...
    <div class="main-content">
        <div class="question-container">
            <p class="instruction">Escolha a frase negativa correta</p>
           

            <div class="options">
                <button class="option-btn">A) The forest aren't dark.</button>
                <button class="option-btn correct ">B) The forest isn't dark.</button>
                <button class="option-btn ">C) The forest not is dark.</button>
            </div>
