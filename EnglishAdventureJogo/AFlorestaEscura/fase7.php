...
// ⭐ DEFINIR: Esta é a FASE 7 do Jogo 2 (Floresta Escura)
$numero_fase = 7; // Fase 7 do Jogo 2
...
$nome_atividade = 'jogo3_fase7'; // Identificador único
...
<head>
    ...
    <style>
        * {
        ...
        .speed-box.left { left: 150px; }
        .speed-box.right { right: 150px; }
    ...
    <div class="main-content">
        <div class="question-container">
            ...
            <div class="audio-box">
                ...
                <div class="speed-box right">
                    <button class="speed-btn" data-speed="1.5">1.5x</button>
                </div>
            </div>

            <div class="options">
                <button class="option-btn" data-is-correct="true">A) The hero isn't tired.</button>
                <button class="option-btn" data-is-correct="false">B) The hero is tired.</button>
                <button class="option-btn" data-is-correct="false">C) The hero aren't tired.</button>
            </div>
...
// ============================================
let audio = new Audio();
audio.src = "sound/thehero.mpeg"; // SUBSTITUA PELO CAMINHO DO SEU ÁUDIO
...
options.forEach(btn => {
    btn.addEventListener("click", () => {
        ...
        mainContent.classList.add("answered-down");
