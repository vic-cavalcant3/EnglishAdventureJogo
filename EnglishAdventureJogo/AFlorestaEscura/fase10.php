    ...
    <div class="main-content">
        <div class="question-container" id="questionContainer">
            ...
            <div class="pronunciation-phrase-box">
                <span class="pronunciation-phrase" id="pronunciationText">The viking is not alone.</span>
            </div>
...
// ============================================
let audio = new Audio();
audio.src = "sound/thevikingisnotalone.mpeg";
...
if (recognition) {
    recognition.addEventListener("result", event => {
        ...
        console.log('🎤 Fala capturada:', spoken);
        ...
        if (correct) {
            ...
            feedback.textContent = "✖ Pronúncia incorreta. Tente novamente ou avance para a próxima fase.";
        ...
        // ⭐ SEMPRE MOSTRA O BOTÃO AVANÇAR (ACERTOU OU ERROU)
    ...
    recognition.addEventListener("error", event => {
        ...
        if (event.error === 'no-speech') {
            feedback.textContent = "⚠️ Nenhuma fala detectada. Tente novamente!";
            feedback.style.color = "#ff9800";
        } else {
            feedback.textContent = "❌ Erro no reconhecimento. Tente novamente!";
            feedback.style.color = "#b71c1c";
        }
    });
}
