...
$numero_fase = 5; // Fase 1 do Jogo 2
...
$nome_atividade = 'jogo3_fase5'; // Identificador único
   ...
   <img src="imgs/sair.png" alt="Sair"/>
    ...
    <div class="main-content">
        ...
        <p class="question-phrase" id="questionPhrase">
            I <span id="answerWord"></span> ready to face Huldra.
        </p>
            <div class="options">
                <button class="option-btn correct ">A) Aren’t </button>
                <button class="option-btn">B) Am not</button>
            </div>
...
options.forEach(btn => {
    btn.addEventListener("click", () => {
        ...
        questionPhrase.innerHTML = `I <span id="chosenWord">${chosenWord}</span> ready to face Huldra.`;
...
function avancar() {
    ...
    if (proximaFase <= 10) {
        ...
        window.location.href = '../fases/mapa.php';
    }
}
