...
// ⭐ DEFINIR: Esta é a FASE 5 do Jogo 4 (Espelhos de Midgard)
$numero_fase = 5;
$jogo_numero = 4;
    ...
    <div class="main-content">
        <div class="question-container" id="questionContainer">
            ...
            <div class="pronunciation-phrase-box">
                <span class="pronunciation-phrase" id="pronunciationText">Are you ready for the question?</span>
            </div>
...
let audio = new Audio();
audio.src = "som/Areyoureadyforthequestion.mp3";
