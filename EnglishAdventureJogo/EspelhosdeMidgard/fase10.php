   ...
   <img src="imgs/sair.png" alt="Sair"/>
    ...
    <div class="main-content">
        <div class="question-container">
            ...
            <p class="question-phrase" id="questionPhrase">Loki is powerful.</p>
...
function processAnswer() {
    ...
    const acceptedAnswersNorm = [
        "is loki powerful",   // Correto ortograficamente
        "is loki powerfull"   // Aceita variação com "powerfull"
    ];
    ...
    if (isCorrect) {
        ...
        const correctAnswer = "Is Loki powerful?";
...
function avancar() {
    ...
    if (proximaFase <= 10) {
        ...
        // ⭐ CORREÇÃO: Voltar para o mapa quando completar todas as fases
