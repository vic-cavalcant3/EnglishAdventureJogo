...
// ⭐ DEFINIR: Esta é a FASE 6 do Jogo 4 (Espelhos de Midgard)
$numero_fase = 6;
$jogo_numero = 4;
   ...
   <img src="imgs/sair.png" alt="Sair"/>
    ...
    <div class="main-content">
        <div class="question-container" id="questionContainer">
            ...
            <p class="question-phrase" id="questionPhrase">O dragão está feliz agora?</p>

            <div class="options">
                <button class="option-btn" data-value="A">A) Are the dragon happy now?</button>
                <button class="option-btn correct" data-value="B">B) Is the dragon happy now?</button>
                <button class="option-btn" data-value="C">C) Am the dragon strong now?</button>
            </div>
